...
public interface SecureAuxTransportSettingsProvider {
     ...
     * @param auxTransportType key for enabling this transport with AUX_TRANSPORT_TYPES_SETTING.
     * @return an instance of {@link SecureAuxTransportParameters}
     */
    default Optional<SecureAuxTransportParameters> parameters(Settings settings, String auxTransportType) throws SSLException {
        return Optional.empty();
    }
