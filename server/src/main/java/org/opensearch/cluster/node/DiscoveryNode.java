...
import org.opensearch.common.settings.Node;
...
import static org.opensearch.common.settings.Node.NODE_ROLES_SETTING;
...
public class DiscoveryNode implements VerifiableWriteable, ToXContentFragment {
    ...
    public String toString() {
        ...
        if (!attributes.isEmpty()) {
            sb.append(attributes.entrySet().stream().collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue)));
        }
        return sb.toString();
    }
