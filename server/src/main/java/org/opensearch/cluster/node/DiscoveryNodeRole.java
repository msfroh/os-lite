...
public abstract class DiscoveryNodeRole implements Comparable<DiscoveryNodeRole> {
    ...
    /**
     * Whether this role is known by this node, or is an {@link UnknownRole}.
     */
    ...
    public static SortedSet<DiscoveryNodeRole> BUILT_IN_ROLES = Collections.unmodifiableSortedSet(
        new TreeSet<>(Arrays.asList(DATA_ROLE, INGEST_ROLE, CLUSTER_MANAGER_ROLE, WARM_ROLE))
    );
    ...
    static class UnknownRole extends DiscoveryNodeRole {
        ...
        public Setting<Boolean> legacySetting() {
            ...
            assert false;
            return Setting.boolSetting("node. " + roleName(), false, Property.NodeScope);
        }
