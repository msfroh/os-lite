...
public abstract class MapBinder<K, V> {
    ...
    private static <K, V> TypeLiteral<Entry<K, Provider<V>>> entryOfProviderOf(TypeLiteral<K> keyType, TypeLiteral<V> valueType) {
    ...
    public static final class RealMapBinder<K, V> extends MapBinder<K, V> implements Module {
        ...
        private static final class MapEntry<K, V> implements Entry<K, V> {
            ...
            public boolean equals(Object obj) {
                return obj instanceof Map.Entry && key.equals(((Entry<?, ?>) obj).getKey()) && value.equals(((Entry<?, ?>) obj).getValue());
            }
