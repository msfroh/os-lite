 ...
 * ports is awkward as org.opensearch.bootstrap.Security is configured previous to Node initialization during
 * bootstrap. To allow pluggable AuxTransports access to configurable port ranges we require the port range be provided
 * through an {@link Setting.AffixSetting} of the form 'AUX_SETTINGS_PREFIX.{aux-transport-key}.ports'.
 */
@ExperimentalApi
